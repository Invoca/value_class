...
describe ActiveTableSet::Configuration::Config do
  ...
  context "database_configuration" do
    it "can report all database confgurations from table sets" do
      ...
      expected = {
          "test"                       => {"database"=>"main", "connect_timeout"=>5, "read_timeout"=>2, "write_timeout"=>2, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"mysql2", "pool"=>5, "reconnect"=>true, "host"=>"10.0.0.1", "username"=>"tester", "password"=>"verysecure"},
          "test_common__leader"        => {"database"=>"main", "connect_timeout"=>5, "read_timeout"=>2, "write_timeout"=>2, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"mysql2", "pool"=>5, "reconnect"=>true, "host"=>"10.0.0.1", "username"=>"tester", "password"=>"verysecure"},
          "test_common__follower_0"    => {"database"=>"replication1", "connect_timeout"=>5, "read_timeout"=>2, "write_timeout"=>2, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"mysql2", "pool"=>5, "reconnect"=>true, "host"=>"10.0.0.2", "username"=>"tester1", "password"=>"verysecure1"},
          "test_common__follower_1"    => {"database"=>"replication2", "connect_timeout"=>5, "read_timeout"=>2, "write_timeout"=>2, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"mysql2", "pool"=>5, "reconnect"=>true, "host"=>"10.0.0.3", "username"=>"tester2", "password"=>"verysecure2"},
          "test_sharded_leader"        => {"database"=>"main", "connect_timeout"=>5, "read_timeout"=>2, "write_timeout"=>2, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"mysql2", "pool"=>5, "reconnect"=>true, "host"=>"11.0.2.1", "username"=>"tester", "password"=>"verysecure"},
          "test_sharded_follower_0"    => {"database"=>"replication1", "connect_timeout"=>5, "read_timeout"=>2, "write_timeout"=>2, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"mysql2", "pool"=>5, "reconnect"=>true, "host"=>"11.0.2.2", "username"=>"tester1", "password"=>"verysecure1"},
          "test_sharded_follower_1"    => {"database"=>"replication2", "connect_timeout"=>5, "read_timeout"=>2, "write_timeout"=>2, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"mysql2", "pool"=>5, "reconnect"=>true, "host"=>"11.0.2.3", "username"=>"tester2", "password"=>"verysecure2"},
          "test_test_scenario_fixture" => {"database"=>"replication1", "connect_timeout"=>5, "read_timeout"=>2, "write_timeout"=>2, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"mysql2", "pool"=>5, "reconnect"=>true, "host"=>"12.0.0.2", "username"=>"tester1", "password"=>"verysecure1"},
          "test_test_scenario_legacy"  => {"database"=>"replication1", "connect_timeout"=>5, "read_timeout"=>2, "write_timeout"=>2, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"mysql2", "pool"=>5, "reconnect"=>true, "host"=>"12.0.0.1", "username"=>"tester1", "password"=>"verysecure1"}
      }
