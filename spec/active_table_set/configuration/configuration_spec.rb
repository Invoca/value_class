...
describe ActiveTableSet::Configuration::Config do
  ...
  context "database_configuration" do
    it "can report all database confgurations from table sets" do
      ...
      expected = {
          "test"                          => {"host"=>"10.0.0.1", "database"=>"main",         "username"=>"tester",                "password"=>"verysecure",          "connect_timeout"=>5, "wait_timeout"=>28800,   "read_timeout"=>110, "write_timeout"=>110, "net_read_timeout" => 600, "net_write_timeout" => 120, "encoding"=>"utf8", "collation"=>"utf8_general_ci", "adapter"=>"stub_client", "pool"=>5, "reconnect"=>true, "checkout_timeout" => 2, "read_only" => false },
